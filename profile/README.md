...
| **IML (I-Lang Machine Layer)** | Experimental machine form of I-Lang v4.x operation chains, fixed-width codes derived from the canon; 0.2 released, not part of the canon | [iml-protocol](https://github.com/ilang-ai/iml-protocol) |
